...
public class TabSwitcher extends FrameLayout implements TabSwitcherLayout, Model {
    ...
    private void obtainStyledAttributes(@Nullable final AttributeSet attributeSet,
        ...
        TypedArray typedArray = getContext()
                .obtainStyledAttributes(attributeSet, R.styleable.IncoTabSwitcher, defaultStyle,
                        defaultStyleResource);

        try {
            int globalTheme = typedArray.getResourceId(R.styleable.IncoTabSwitcher_themeGlobal, 0);
            int phoneTheme = typedArray.getResourceId(R.styleable.IncoTabSwitcher_themePhone, 0);
            int tabletTheme = typedArray.getResourceId(R.styleable.IncoTabSwitcher_themeTablet, 0);
    ...
    private void obtainPreserveState(@NonNull final TypedArray typedArray) {
        setPreserveState(typedArray.getBoolean(R.styleable.IncoTabSwitcher_preserveState, false));
    }
    ...
    private void obtainLayoutPolicy(@NonNull final TypedArray typedArray) {
        int value = typedArray.getInt(R.styleable.IncoTabSwitcher_incoLayoutPolicy, 0);
    ...
    private void obtainBackground(@NonNull final TypedArray typedArray) {
        Drawable background = typedArray.getDrawable(R.styleable.IncoTabSwitcher_android_background);
    ...
    private void obtainTabIcon(@NonNull final TypedArray typedArray) {
        int resourceId = typedArray.getResourceId(R.styleable.IncoTabSwitcher_tabIcon, 0);
    ...
    private void obtainTabIconTint(@NonNull final TypedArray typedArray) {
        setTabIconTintList(typedArray.getColorStateList(R.styleable.IncoTabSwitcher_tabIconTint));
    }
    ...
    private void obtainTabBackgroundColor(@NonNull final TypedArray typedArray) {
        setTabBackgroundColor(
                typedArray.getColorStateList(R.styleable.IncoTabSwitcher_tabBackgroundColor));
    }
    ...
    private void obtainTabContentBackgroundColor(@NonNull final TypedArray typedArray) {
        setTabContentBackgroundColor(
                typedArray.getColor(R.styleable.IncoTabSwitcher_tabContentBackgroundColor, -1));
    }
    ...
    private void obtainAddTabButtonColor(@NonNull final TypedArray typedArray) {
        setAddTabButtonColor(
                typedArray.getColorStateList(R.styleable.IncoTabSwitcher_addTabButtonColor));
    }
    ...
    private void obtainTabTitleTextColor(@NonNull final TypedArray typedArray) {
        setTabTitleTextColor(
                typedArray.getColorStateList(R.styleable.IncoTabSwitcher_tabTitleTextColor));
    }
    ...
    private void obtainTabCloseButtonIcon(@NonNull final TypedArray typedArray) {
        int resourceId = typedArray.getResourceId(R.styleable.IncoTabSwitcher_tabCloseButtonIcon, 0);
    ...
    private void obtainTabCloseButtonIconTint(@NonNull final TypedArray typedArray) {
        setTabIconTintList(
                typedArray.getColorStateList(R.styleable.IncoTabSwitcher_tabCloseButtonIconTint));
    }
    ...
    private void obtainShowToolbars(@NonNull final TypedArray typedArray) {
        showToolbars(typedArray.getBoolean(R.styleable.IncoTabSwitcher_showToolbars, false));
    }
    ...
    private void obtainToolbarTitle(@NonNull final TypedArray typedArray) {
        setToolbarTitle(typedArray.getText(R.styleable.IncoTabSwitcher_toolbarTitle));
    }
    ...
    private void obtainToolbarNavigationIcon(@NonNull final TypedArray typedArray) {
        int resourceId =
                typedArray.getResourceId(R.styleable.IncoTabSwitcher_toolbarNavigationIcon, -1);
    ...
    private void obtainToolbarNavigationIconTint(@NonNull final TypedArray typedArray) {
        setToolbarNavigationIconTintList(
                typedArray.getColorStateList(R.styleable.IncoTabSwitcher_toolbarNavigationIconTint));
    }
    ...
    private void obtainToolbarMenu(@NonNull final TypedArray typedArray) {
        int resourceId = typedArray.getResourceId(R.styleable.IncoTabSwitcher_toolbarMenu, 0);
    ...
    private void obtainTabPreviewFadeThreshold(@NonNull final TypedArray typedArray) {
        int threshold = typedArray.getInteger(R.styleable.IncoTabSwitcher_tabPreviewFadeThreshold, -1);
    ...
    private void obtainTabPreviewFadeDuration(@NonNull final TypedArray typedArray) {
        int duration = typedArray.getInteger(R.styleable.IncoTabSwitcher_tabPreviewFadeDuration, -1);
    ...
    private void obtainEmptyView(@NonNull final TypedArray typedArray) {
        int resourceId = typedArray.getResourceId(R.styleable.IncoTabSwitcher_emptyView, 0);
        ...
        if (resourceId != 0) {
            long animationDuration =
                    typedArray.getInteger(R.styleable.IncoTabSwitcher_emptyViewAnimationDuration, -2);
